PREDICTION_CONFIG = {
    "runtime_in_minutes": 5,         # Prediction will stop either after specified runtime or after reaching
    "max_number_of_results": 5,     # max number of results, whichever comes first.
