PREDICTION_CONFIG = {
    "runtime_in_minutes": 1,         # Prediction will stop either after specified runtime or after reaching
    "max_number_of_results": 1,     # max number of results, whichever comes first.
